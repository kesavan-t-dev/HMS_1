...
DEBUG: false
ALLOWED_HOSTS: yourdomain.vercel.app,www.yourdomain.vercel.app
...
# Run migrations locally with pulled environment
python manage.py migrate --settings=hms.settings

# Or use Vercel Functions:
# Create vercel/migrations.py to run migrations post-deploy
```
...
# (Through Vercel dashboard - Deployments tab)
```
